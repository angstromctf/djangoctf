...
urlpatterns = [
    ...
    url(r'^account/$', views.user.account, name='account'),
    url(r'^account/change_password/$', views.user.change_password, name='change_password'),
    ...
    url(r'^account/signup/$', views.user.signup, name='signup'),
    ...
    url(r'^activate/(?P<key>.+)/$', views.user.activation, name='activation'),
    url(r'^new-activation-link/(?P<user_id>\d+)/$', views.user.new_activation_link, name='new_link'),
]
